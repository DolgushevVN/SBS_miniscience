...
def boundary_electrostriction(E, po, pi, oe_r, ie_r, direction, boundary , offset = 1e-12):
    ...
    for idx, point in enumerate( boundary.midpoints):
        ...
        ipoint_t = tuple(ipoint)
        opoint_t = tuple(opoint)
        iElocal = np.array([E[0](ipoint_t), E[1](ipoint_t), E[2](ipoint_t)])
        oElocal = np.array([E[0](opoint_t), E[1](opoint_t), E[2](opoint_t)])
